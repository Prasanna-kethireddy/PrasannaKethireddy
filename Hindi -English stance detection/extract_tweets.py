...
fp = open("Notebandi_tweets_with_language.txt", 'r')
...
fp = open("Notebandi_tweets.txt", 'r')
id_tweet_map = {}
tweet_id_map = {}
count = 0
for line in fp:
...
fp = open("Notebandi_tweets_stance.txt", 'r')
id_stance_map = {}
for line in fp:
	line = line.strip()
	if line == '':
...
def get_id_stance_map():
	return id_stance_map
