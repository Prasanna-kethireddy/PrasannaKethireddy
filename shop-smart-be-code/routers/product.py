...
@router.get("/{product_id}", response_model=ProductValidator)
...
@router.get("/", response_model=List[ProductValidator])
...
@router.delete("/{product_id}", response_model=ProductValidator)
